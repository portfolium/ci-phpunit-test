...
class CIPHPUnitTest
{
    ...
    public static function init(array $autoload_dirs = null)
    {
        ...
        /*
         * --------------------------------------------------------------------
         * LOAD THE Common overrides for CI
         * --------------------------------------------------------------------
         *
         * This was necessary b/c we override a bunch of common functionality
         * Also NOTE: I wrapped set_header_function in /replacing/core/Common.php with a check if the function is defined
         */
